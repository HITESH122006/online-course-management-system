...
export default function AdminCoursesCRUDPage() {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(
          "Failed to load courses from MongoDB API"
        );
      }
  ...
  const handleCreateCourse = async (
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        throw new Error(
          data.message ||
            "Failed to create course in MongoDB"
        );
      }

      setSuccess(
        `Course "${courseData.title}" successfully inserted into MongoDB Atlas!`
      );
  ...
  const handleUpdateCourse = async (
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        throw new Error(
          data.message ||
            "Failed to update course in MongoDB"
        );
      }

      setSuccess(
        `Course "${courseData.title}" successfully updated in MongoDB Atlas!`
      );
  ...
  const handleDeleteCourse = async (
    ...
    const confirmed = confirm(
      `Are you sure you want to delete "${title}" permanently from MongoDB Atlas?`
    );
    ...
    try {
      ...
      setSuccess(
        `Course "${title}" and associated data permanently deleted from MongoDB Atlas!`
      );
  ...
  return (
    <div className="page-container">
      ...
      <div className="admin-page-header">
        ...
        <div>
          ...
          <p className="page-subtitle">
            ...
            course records directly stored in
            MongoDB Atlas{" "}
            <code>courses</code> collection.
          </p>
      ...
      {loading ? (
        ...
        <Loading
          message="Querying courses from MongoDB Atlas..."
        />
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>
                        ...
                        <span
                          className={`card-level-badge level-${(
                            course.level ||
                            "Beginner"
                          ).toLowerCase()}`}
                        >
